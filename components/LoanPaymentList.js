                ...
                <View style={styles.infoGrid}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <TouchableOpacity onPress={() => handlePhonePress(phone)}>
                            <Text style={[styles.infoValue, styles.phoneNumber]}>{phone}</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <Text style={styles.infoValue}>{loanId}</Text>
                    </View>

                    <View style={styles.infoRow}>
                        <View style={styles.infoItem}>
                            <Feather name="star" size={14} color={COLORS.gray} />
                            <Text style={styles.infoLabel}>Loan Amount</Text>
                        </View>
                        <Text style={styles.infoValue}>₹{loanAmount}</Text>
                    </View>
                </View>
