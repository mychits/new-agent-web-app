...
import { Ionicons, MaterialIcons } from "@expo/vector-icons"; // Added MaterialIcons for seats
...
const VACANCY_COLOR = "#059669"; // Green for vacant seats
...
const formatNumberIndianStyle = (num) => {
  ...
  if (otherNumbers !== "") {
    formattedIntegerPart = otherNumbers.replace(
      /\B(?=(\d{2})+(?!\d))/g,
      ","
    ) + "," + lastThree;
  }
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
        ...
        <LinearGradient colors={TOP_GRADIENT} style={styles.topContainer}>
            {/* The headerSpacer is adjusted to move the Header up */}
        ...
        <View style={styles.mainContentArea}>
            {isLoading ? (
                ...
                <View style={styles.errorContainer}>
                    <Ionicons name="alert-circle-outline" size={50} color={MODERN_PRIMARY} />
                ...
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptyTextBlue}>No groups found for this filter.</Text>
                </View>
            ) : (
                <ScrollView
                ...
                >
                    {cardsData.map((group) => (
                        <TouchableOpacity 
                            ...
                            activeOpacity={0.7} // Improved press feedback
                            onPress={() => Alert.alert('Group Details', `Navigating to details for ${group.group_name}`)}
                        >
                            <View style={styles.cardHeader}>
                                ...
                                <View style={[
                                    ...
                                    // Default/Other status styling
                                ]}>
                                    <Text style={[styles.tagText, group.status === 'New' && { color: MODERN_PRIMARY }]}>
                                        {group.status || "Active"}
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.cardBody}>
                                <View style={styles.row}>
                                    ...
                                    <Text style={[styles.cardTextBold, { color: ACCENT_BLUE }]}>
                                ...
                                <View style={styles.rowVacant}>
                                    <MaterialIcons name="event-seat" size={20} color={VACANCY_COLOR} />
...
const styles = StyleSheet.create({
    ...
    mainContentArea: {
        flex: 1,
        backgroundColor: SUBTLE_BG_GREY, // Very light grey background for content
    ...
    chip: {
        ...
        paddingHorizontal: 20, // Slightly wider chips
        paddingVertical: 10,
    ...
    selectedChipText: {
        color: MODERN_PRIMARY, // Darker text for better contrast in selected chip
        fontWeight: "800",
    },
    ...
    cardHeader: {
        ...
        marginBottom: 15,
        paddingBottom: 8, // Added subtle padding to push body down
        borderBottomWidth: 0.5, // Subtle separator line in the header
    ...
    tagNew: {
        backgroundColor: '#ffedd5', // Light orange/cream for 'New'
    },
    tagText: {
        color: VACANCY_COLOR, // Default active/other tags use green/blue
        fontWeight: "700",
        fontSize: 11,
    ...
    cardTextBold: {
        fontSize: 16, // Slightly larger for values
        fontWeight: '800',
    ...
    rowVacant: {
        ...
        gap: 8,
        paddingVertical: 4,
        backgroundColor: '#f0fdf4', // Very light background for vacant seats row
        borderRadius: 8,
