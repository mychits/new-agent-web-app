          ...
          <View style={styles.dropdownWrapper}>
            ...
            <View style={styles.pickerWrapper}>
              <Picker
                ...
                // FIX: Removed the color style from the main Picker 'style' prop 
                // as this frequently causes the "Text strings must be rendered within a <Text> component" error.
                // It is better to rely on itemStyle for iOS and the PickerWrapper background/borderColor for Android contrast.
                style={styles.picker} 
...
const styles = StyleSheet.create({
  ...
  // Added separate Picker style for a clean look
  picker: {
    height: 40, // Ensure a consistent height
    width: '100%',
    // On Android, the color prop here is what frequently causes the error, 
    // so we've removed the explicit color: MODERN_PRIMARY from the component call.
    // If text color needs to be forced on Android, it's often done via a wrapper style or a custom native module.
  },
  ...
  balanceRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    paddingVertical: 8, // Decreased slightly from 10
    marginTop: 4,      // Significantly decreased from 10 to reduce gap above
