...
const MODERN_PRIMARY = "#0d0d0dff"; // Dark text/headers
                ...
                {loading ? (
                    ...
                    <View style={styles.screenContainer}> 
                        ...
                        <View style={styles.fixedHeaderArea}>
                            <View style={{ marginHorizontal: 22, marginTop: Platform.OS === 'android' ? 0 : 22 }}>
                                <Header />
                                            ...
                                            {filteredCustomers.length > 0 ? (
                                                filteredCustomers.map((customer, index) => (
                                                    <View key={index} style={styles.paymentDetailItem}>
                                                        ...
                                                        <Text style={styles.paymentDetailText}>
                                                            <Text style={styles.paymentDetailLabel}>Group:</Text> {customer?.group_id?.group_name || 'N/A'}
                                                        </Text>
                                                        <Text style={styles.paymentDetailText}>
