...
import { View, Text, Alert, StyleSheet, ActivityIndicator, BackHandler } from "react-native";
...
const PigmePrint = ({ route }) => {
    ...
    const handleConnect = async () => {
        ...
        try {
            ...
            setIsConnecting(false);
            Alert.alert("Connection Error", "Failed to connect to printer. " + error.message);
        }
    };
                ...
                <div class="receipt-container">
                    ...
                    <div class="details">
                        ...
                        <div class="flex-row">
                            ...
                            <span class="info">${custom_pigme_id || "N/A"}</span>
                        </div>
                        <div class="flex-row">
    ...
    const handlePrint = async () => {
        setIsPrinting(true);
        try {
            await RNPrint.print({ html: generateReceiptHtml() });
        } catch (error) {
    ...
    const handlePosPrint = async () => {
        ...
        try {
            ...
            Alert.alert("POS Print Error", "Failed to print to POS. " + error.message);
        } finally {
            setIsPrinting(false);
        }
    };
