...
const handleEnrollCustomer = async () => {
  ...
  if (!formFields.user_id || !formFields.group_id || !formFields.no_of_tickets) {
  ...
  const ticketEntries = availableTickets.slice(0, ticketsCount).map((ticketNumber) => ({
    user_id,
    group_id,
							...
							<View style={styles.cardContainer}>
								<View style={styles.contentContainer}>
									...
									<View style={styles.formGroup}>
										...
										>
											<Text style={styles.selectedCustomerText}>
												{formFields.user_id ?
													agentCustomers.find(c => c._id === formFields.user_id)?.full_name || 'Select Customer'
													: 'Select Customer'
												}
											</Text>
										</TouchableOpacity>
									...
									<View style={styles.formGroup}>
										...
										<View style={[styles.inputGroup, focusedInput === 'no_of_tickets' && styles.inputGroupFocused]}>
											<TextInput
