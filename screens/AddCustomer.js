							...
							<View style={styles.cardContainer}>
								<View style={styles.contentContainer}>
									...
									<View>
										...
										<View style={[styles.inputGroup, focusedInput === 'full_name' && styles.inputGroupFocused]}>
									...
									<View style={styles.row}>
										...
										<View style={styles.column}>
											...
											<View style={[styles.inputGroup, focusedInput === 'phone_number' && styles.inputGroupFocused]}>
										...
										<View style={styles.column}>
											...
											<View style={[styles.inputGroup, focusedInput === 'pincode' && styles.inputGroupFocused]}>
												<Feather name="map-pin" size={18} color="#888" style={styles.icon} />
												<TextInput
													style={styles.textInput}
													placeholder="Pincode"
													keyboardType="number-pad"
									...
									<View>
										...
										<View style={[styles.inputGroup, focusedInput === 'adhaar_no' && styles.inputGroupFocused]}>
											<Feather name="credit-card" size={18} color="#888" style={styles.icon} />
											<TextInput
												style={styles.textInput}
									...
									<View>
										...
										<View style={[styles.inputGroup, focusedInput === 'pan_no' && styles.inputGroupFocused]}>
											<Feather name="file-text" size={18} color="#888" style={styles.icon} />
											<TextInput
												style={styles.textInput}
									...
									<View>
										...
										<View style={[styles.inputGroup, focusedInput === 'address' && styles.inputGroupFocused]}>
											<Feather name="home" size={18} color="#888" style={styles.icon} />
											<TextInput
												style={styles.textInput}
